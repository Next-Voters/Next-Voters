        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-[1100px] mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24">
            <div className="flex justify-center mb-8">
              <span className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/80 backdrop-blur px-3.5 py-1.5 text-[12px] font-medium text-gray-700">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-red-500 animate-pulse" />
                Nonpartisan civic AI, grounded in official sources
              </span>
            </div>
